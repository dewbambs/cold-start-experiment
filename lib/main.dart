...
import 'package:carousel_example/carousel_example.dart';
import 'package:dots_indicator_example/dots_indicator_example.dart';
import 'package:cache_manager_example/cache_manager_example.dart';
import 'package:downloader_example/downloader_example.dart';
import 'package:staggered_grid_example/staggered_grid_example.dart';
import 'package:svg_lottie_example/svg_lottie_example.dart';
...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final examples = <String, WidgetBuilder>{
      ...
      'Carousel Example': (context) => const CarouselExamplePage(),
      'Dots Indicator Example': (context) => const DotsIndicatorExamplePage(),
      'Cache Manager Example': (context) => const CacheManagerExamplePage(),
      'Downloader Example': (context) => const DownloaderExamplePage(),
      'Staggered Grid Example': (context) => const StaggeredGridExamplePage(),
      'SVG & Lottie Example': (context) => const SvgLottieExamplePage(),
      ...
      'Intl & Logger Example': (context) => const IntlLoggerExamplePage(),
    };
